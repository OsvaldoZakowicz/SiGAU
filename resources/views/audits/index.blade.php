    ...
    <div class="w-full h-max flex flex-col p-1">
        ...
        <div class="bg-zinc-300">
            ...
            <div class="p-1 flex justify-center items-center bg-zinc-400">
                <h3 class="text-sm font-bold text-zinc-800 uppercase inline-block">auditoria: listado de los últimos movimientos</h3>
            </div>
            ...
            @if (count($validated) !== 0)
                <div class="m-1 p-1 flex items-center justify-between mt-2 text-md text-zinc-700 border border-zinc-300 bg-zinc-100">
                    <div>
