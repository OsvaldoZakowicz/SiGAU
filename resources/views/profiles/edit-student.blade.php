...
@section('student-content')
    <div class="w-full h-max flex flex-col p-1">
        ...
        <div class="my-2 mx-auto w-full border bg-white border-zinc-200">
            {!! Form::model($user, ['method' => 'PUT', 'route' => ['update-account-student', $user]]) !!}
            <div class="flex flex-col items-center justify-center">
                ...
                <div class="w-full mt-2 p-2 border-b border-zinc-300">
                    ...
                    <span class="block font-medium text-sm text-red-600">AVISO! deje los campos de contraseña vacios, para
                        que la cuenta mantenga la misma. O cambie la contraseña definiendo una nueva!</span>
                    <span class="block font-medium text-sm text-red-600">AVISO! si cambia su correo electrónico, deberá
                        confirmarlo nuevamente y volver a iniciar sesión!</span>
                </div>
                {{-- buttons --}}
