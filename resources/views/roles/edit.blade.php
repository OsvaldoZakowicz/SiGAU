                ...
                <div class="w-full mt-2 p-2">
                    ...
                    <div class="flex flex-col max-h-48 flex-wrap items-start justify-start">
                        @foreach ($permission as $item)
                            <label>
                                {!! Form::checkbox('permission[]', $item->id, in_array($item->id, $rolePermissions) ? true : false, ['class' => 'rounded border-zinc-300 text-indigo-600 shadow-sm focus:border-zinc-300 focus:ring focus:ring-zinc-200 focus:ring-opacity-50']) !!}
