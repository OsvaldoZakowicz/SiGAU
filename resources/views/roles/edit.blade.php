    ...
    <div class="w-full h-max flex flex-col p-1">
        ...
        <div class="bg-zinc-300">
            ...
            <div class="p-1 flex justify-center items-center bg-zinc-400">
                <h3 class="text-sm font-bold text-zinc-800 uppercase inline-block">roles: editar rol</h3>
            </div>
        </div>
        {{-- formulario, model --}}
        <div class="my-2 mx-auto w-full border bg-white border-zinc-200">
            <span class="mx-1 p-1 text-sm text-red-500">Al editar el rol <b>{{$role->name}}</b> este cambiará para todos los usuarios que lo tengan, sea cuidadoso!</span>
